...
assertCondition(app.includes("API Key 是模型服务商给你的访问凭证"), "API Key help should explain what a key is in ordinary language.");
assertCondition(app.includes("打开桌面版后"), "Full setup guidance should tell web-demo users the concrete desktop next step.");
...
assertCondition(app.includes("桌面版从哪里来"), "Web setup guidance should explain the desktop package path.");
